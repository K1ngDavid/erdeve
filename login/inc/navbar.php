    ...
    <div class="container-fluid">
        ...
        <div id="bs-example-navbar-collapse-1" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li><a href="#"><i data-toggle="tooltip" data-placement="bottom" title="Aide" style="font-size:20px;" class="icon-help tooltitle"></i></a>
                </li>
            ...
            <ul style="margin-right:0;" class="nav navbar-nav navbar-right">
                <li>
                    ...
                    <ul style="margin-top:14px;" role="menu" class="dropdown-setting dropdown-menu">
                        <li>
                            <a href="#">
                                <span class="entypo-user"></span>&#160;&#160;Profil</a>
                        </li>
                        <li>
                            <a href="#">
                                <span class="entypo-user"></span>&#160;&#160;Abonnement</a>
                        </li>
                        <li class="divider"></li>
                        <li>
                            <a href="#">
                                <span class="entypo-logout"></span>&#160;&#160;Deconnexion</a>
                        </li>
                    </ul>
                </li>
                <!--
